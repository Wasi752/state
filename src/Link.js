    ...
    return (
        <div className="w-full h-screen flex">
            ...
            <div className="flex flex-col justify-center m-5 w-[50%] h-[70%] mt-20 bg-gray-100">
                ...
                <Link to="/time" className="border border-blue-300 w-[70%] p-5 ml-20 mb-2 text-xl hover:text-blue-600">Current Date & Time</Link>
                <Link to="/color" className="border border-blue-300 w-[70%] p-5 ml-20 mb-2 text-xl hover:text-blue-600">Change Color</Link>
            </div>
            <div className="w-[25%] h-full"></div>
        </div>
    )
